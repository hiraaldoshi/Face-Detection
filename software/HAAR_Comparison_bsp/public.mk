...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../final_proj_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is final_proj_soc
SOPC_NAME := final_proj_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1544793684
SOPC_SYSID_FLAG += --timestamp=1544793684
ELF_PATCH_FLAG  += --timestamp 1544793684
